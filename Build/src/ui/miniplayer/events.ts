...
export class MiniplayerEvents {
  private listeners: Map<MiniplayerEvent, Set<EventCallback<unknown>>> =
    new Map();

  on<E extends MiniplayerEvent>(
    event: E,
    callback: EventCallback<MiniplayerEventMap[E]>,
  ): void {
